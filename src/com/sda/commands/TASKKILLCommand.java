...
public class TASKKILLCommand extends Command {
    ...
    public TASKKILLCommand(String name, int cntArg) {
        super(name, cntArg);
    }
    ...
    public void Execute(){
        ...
        try {            
            ...
            if(ArgumentString != null){
                p = Runtime.getRuntime().exec(System.getenv("windir") + "\\system32\\"+"taskkill.exe" + ArgumentString);
            } else {
                p = Runtime.getRuntime().exec(System.getenv("windir") + "\\system32\\"+"taskkill.exe");
            }
